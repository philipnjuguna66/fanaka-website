<footer class="bg-secondary-900 py-12" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto md:w-4/5 max-w-5xl px-6 lg:px-8">
        ...
        <div class="mt-16 border-t border-white/10 pt-2 sm:mt-2 lg:mt-2 text-center">
            <p class="text-xs leading-5 text-gray-50 ">&copy; 2019-{{ now()->format('Y') }}
                ...
                <span class=" text-gray-50/70">Powered By <a
                        href="https://lifelong.co.ke/business-solutions" target="_blank">Lifelong Group</a> </span>
            </p>
        </div>
                                ...
                                <div class="flex justify-between gap-2">
                                    ...
                                    <div class="flex flex-col">
                                        <a target="_blank"
                                           ...
                                           href="https://api.whatsapp.com/send/?phone=++254759100100&text=may I know more about this project">
